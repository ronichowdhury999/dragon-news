    ...
    return (
        <div><footer className="footer items-center p-4">
            ...
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end justify-self-center ">
                ...
                <a target="_blank" href="https://www.youtube.com/@Emotionalstatus999">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                ...
                <a target="_blank" href="https://www.facebook.com/@i.mdroni">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
